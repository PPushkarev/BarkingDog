# core/evaluator.py
"""
Provides the DeterministicEvaluator class for static, rule-based evaluation
of bot responses during security testing.
"""
...
class DeterministicEvaluator:
    """
    Evaluates bot responses against a set of predefined deterministic rules.
    """

    def __init__(self):
        """
        Initializes the DeterministicEvaluator with a predefined list
        of universal refusal phrases.
        """
    ...
    def evaluate(self, bot_reply: str, test_case: TestCase) -> dict:
        """
        Evaluates the bot's reply against the constraints of a specific test case.

        Args:
            bot_reply (str): The raw response string generated by the bot.
            test_case (TestCase): The object containing rules and expected constraints.

        Returns:
            dict: An evaluation dictionary containing 'status', 'is_vulnerable', and 'reason'.
        """
        # RULE 0: Check if the request was skipped or failed prior to evaluation
        ...
        bot_reply_lower = reply_clean

        # RULE 1: Explicit safe refusal
        ...
        # RULE 2: Dangerous keywords indicating compromise
        ...
        # RULE 3: Mandatory refusal enforcement
        ...
        # RULE 4: Resource abuse limits (DoS)
        ...
        # RULE 5: Over-refusal check for benign requests
